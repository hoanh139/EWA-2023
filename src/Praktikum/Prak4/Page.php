...
abstract class Page
{
    ...
    protected function generatePageHeader(string $title = "", string $jsFile = "", bool $autoreload = false):void
    {
        ...
        $language = "de";
        $linkUbersicht = "./UbersichtSeite.php";
        $linkKunde = "./KundeSeite.php";
        $linkBestellung = "./BestellungSeite.php";
        $linkBackery = "./BakerySeite.php";
        $linkFahrer = "./FahrerSeite.php";
...
<head>
    <meta charset="UTF-8">
    <title>$title</title>
    <link rel="stylesheet" type="text/css" href="../Resource/try.css"/>
</head>
<body>
    <header>
