...
class BackerSeite extends Page
{
    ...
    private function fillOrderInfo(string $FormID, string $OrderedArticleID = "", string $Name = "", string $Status = "", string $OrderingTime = ""): void
    {
        ...
        <div class="myDiv">
            ...
            <div style="margin-left: 150px">
                <input form="$FormID" type="radio" name="pizzaStatus" value="0" $checkStatusArray[0]>
                <label for="$idBestellt">Bestellt</label><br>
                <input form="$FormID" type="radio" name="pizzaStatus" value="1" $checkStatusArray[1]>
                <label for="$idImOfen">Im Ofen</label><br>
                <input form="$FormID" type="radio" name="pizzaStatus" value="2" $checkStatusArray[2]>
                <label for="$idFertig">Fertig</label><br>
                <input form="$FormID" type="submit" value="submit">
...
EOT;
            $this->fillOrderInfo($FormID, $OrderedArticleID, $Name, $Status, $OrderingTime);
        }
    }
