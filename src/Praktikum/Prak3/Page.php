...
abstract class Page
{
    ...
    protected function generatePageHeader(string $title = "", string $jsFile = "", bool $autoreload = false):void
    {
        ...
        $language = "de";
        $linkUbersicht = "http://localhost/Praktikum/Prak3/UbersichtSeite.php";
        $linkKunde = "http://localhost/Praktikum/Prak3/KundeSeite.php";
        $linkBestellung = "http://localhost/Praktikum/Prak3/BestellungSeite.php";
        $linkBackery = "http://localhost/Praktikum/Prak3/BakerySeite.php";
        $linkFahrer = "http://localhost/Praktikum/Prak3/FahrerSeite.php";
