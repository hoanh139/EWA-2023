...
class BackerSeite extends Page
{
    ...
    protected function getViewData(): array
    {
        ...
        $SQLAbfrage = "SELECT oa.ordered_article_id, a.name, oa.status, o.ordering_time FROM article a NATURAL JOIN ordered_article oa NATURAL JOIN ordering o WHERE oa.status < 3 ORDER BY o.ordering_time, oa.ordered_article_id;";
    ...
    private function fillOrderInfo(string $OrderedArticleID = "", string $Name = "", string $Status = "", string $OrderingTime = ""): void
    {
        ...
        echo <<<EOT
        <div class="myDiv">
            <h2 style="text-align: center">$OrderedArticleID $Name </h2>
            <div style="margin-left: 150px">
                <input type="radio" id="$idBestellt" name="$OrderedArticleID" value="0" $checkStatusArray[0]>
                <label for="$idBestellt">Bestellt</label><br>
                <input type="radio" id="$idImOfen" name="$OrderedArticleID" value="1" $checkStatusArray[1]>
                <label for="$idImOfen">Im Ofen</label><br>
                <input type="radio" id="$idFertig" name="$OrderedArticleID" value="2" $checkStatusArray[2]>
...
EOT;
    ...
    protected function generateView(): void
    {
        ...
        echo <<<EOT
    <h1>Bäcker</h1>
    <form action="BakerySeite.php" id="BackerInfos" method="post" lang="de" accept-charset="UTF-8">
...
EOT;
        foreach ($data as $bestellung){
            ...
            $this->fillOrderInfo( $OrderedArticleID, $Name, $Status, $OrderingTime);
        }
        echo <<<EOT
