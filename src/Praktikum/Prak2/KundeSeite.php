...
class Kunde extends Page
{
    ...
    {
        $SQLabfrage = "SELECT oa.ordered_article_id, a.name, oa.status FROM ordered_article oa NATURAL JOIN article a ORDER BY oa.ordered_article_id";
...
EOT;
    ...
    protected function generateView():void
    {
        ...
        echo <<<EOT
        <h1>Kunde</h1>
        <form action="KundeSeite.php" id="KundeInfos" method="post" lang="de" accept-charset="UTF-8">
EOT;
