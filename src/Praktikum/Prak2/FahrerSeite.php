...
class Fahrer extends Page
{
                ...
                <tr>
                    <td colspan="2">
                        <table>
                            <tr>
                                <td>
                                    <input type="radio" id="$idFertig" name="$OrderingID" value="Fertig" $checkStatusArray[0]>
                                    <label for="$idFertig">Fertig</label><br>
                                </td>
                                <td>
                                    <input type="radio" id="$idUnterwegs" name="$OrderingID" value="Unterwegs" $checkStatusArray[1]>
                                    <label for="$idUnterwegs">Unterwegs</label><br>
                                </td>
                                <td>
                                    <input type="radio" id="$idGeliefert" name="$OrderingID" value="Geliefert" $checkStatusArray[2]>
    ...
    protected function generateView():void
    {
        ...
        echo <<<EOT
        <h1>Fahrer</h1>
        <form action="FahrerSeite.php" id="FahrerInfos" method="post" lang="de" accept-charset="UTF-8">
        EOT;
