...
abstract class Page
{
    ...
    protected function generatePageHeader(string $title = "", string $jsFile = "", bool $autoreload = false):void
    {
        ...
        $language = "de";
        $linkUbersicht = "http://localhost/Praktikum/Prak2/UbersichtSeite.php";
        $linkKunde = "http://localhost/Praktikum/Prak2/KundeSeite.php";
        $linkBestellung = "http://localhost/Praktikum/Prak2/BestellungSeite.php";
        $linkBackery = "http://localhost/Praktikum/Prak2/BakerySeite.php";
        $linkFahrer = "http://localhost/Praktikum/Prak2/FahrerSeite.php";
