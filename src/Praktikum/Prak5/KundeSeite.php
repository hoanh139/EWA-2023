...
{
    protected bool $isSessionSet = false;
    ...
    private function fillStatusInfo(string $OrderedArticleID = "", string $Name = "", string $Status = ""):void
    {
        ...
        <section class="myDiv">
            <h2>$Name</h2>
            <h3>Order ID is: $OrderedArticleID</h3>
...
EOT;
    ...
    protected function generateView():void
    {
        ...
        echo <<<EOT
        <script src="StatusUpdate.js?v=123"></script>        
        <h1>Kunde</h1>
...
EOT;
        if (!$this->isSessionSet) {
            ...
            <div class="alert">
                ...
                No Session Available. Please Order!
            </div>
...
EOT;
            ...
            <div class="alert">
                <span onclick="this.parentElement.style.display='none';">&times;</span> 
                No Pizza Available. Please Order!
            </div>
