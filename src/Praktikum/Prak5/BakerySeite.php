...
class BackerSeite extends Page
{
    ...
    private function fillOrderInfo(string $FormID, string $OrderedArticleID, string $OrderingID, string $Name, string $Status, string $OrderingTime): void
    {
        ...
        <div class="myDiv">
            ...
            <p>$OrderingTime </p>
            <div>
                <input form="$FormID" type="radio" id="$idBestellt" name="pizzaStatus" value="0" onclick="document.forms['$FormID'].submit();" $checkStatusArray[0]>
                <label for="$idBestellt">Bestellt</label><br>
                <input form="$FormID" type="radio" id="$idImOfen" name="pizzaStatus" value="1" onclick="document.forms['$FormID'].submit();" $checkStatusArray[1]>
                <label for="$idImOfen">Im Ofen</label><br>
                <input form="$FormID" type="radio" id="$idFertig" name="pizzaStatus" value="2" onclick="document.forms['$FormID'].submit();" $checkStatusArray[2]>
